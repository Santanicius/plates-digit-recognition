...
for filename in imagefiles:
    ...
    # contours_placa, hierarchy_placa = cv2.findContours(thresh_placa, cv2.RETR_TREE, cv2.CHAIN_APPROX_NONE)
    # cv2.drawContours(img_placa, contours_placa, -1, (255, 0, 0), 1)

    cv2.imshow(filename+"_placa",thresh_placa)    
